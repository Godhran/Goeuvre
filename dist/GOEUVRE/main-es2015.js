...
function MobComponent__svg_line_8_Template(rf, ctx) { if (rf & 1) {
...
class MobComponent {
    constructor() {
        ...
        this.bodyAnimation = new gsap__WEBPACK_IMPORTED_MODULE_1__["TimelineLite"]({ paused: true, repeat: -1, ease: gsap__WEBPACK_IMPORTED_MODULE_1__["Elastic"].easeInOut });
        this.linesAnimations = new gsap__WEBPACK_IMPORTED_MODULE_1__["TimelineLite"]({ paused: true, repeat: -1, ease: gsap__WEBPACK_IMPORTED_MODULE_1__["Power0"].easeNone });
    }
    ngOnInit() {
    ...
    initaliseLines() {
        ...
        this.linesAnimations
            ...
            .fromTo('#Lines', 0.3, {
            transformOrigin: "50% 50%",
            y: 300, ease: gsap__WEBPACK_IMPORTED_MODULE_1__["Power0"].easeNone
        }, {
            y: 0, ease: gsap__WEBPACK_IMPORTED_MODULE_1__["Power0"].easeNone
        }, "=-0");
        this.linesAnimations.play();
        // this.numberAnimation
        // .fromTo('#Lines', 0.5, {
